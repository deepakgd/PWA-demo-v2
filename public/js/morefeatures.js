export default {
    init: function () {
        ...
        // ---------------------------------------
        // foreground detection/browser sleep time detection
        // ---------------------------------------
        var target = document.getElementById('foregrondTarget');
        ...
        if (hidden in document) {
            document.getElementById('foregroundStatus').innerHTML = document[hidden] ? 'hidden' : 'visible';
        }
    }
}